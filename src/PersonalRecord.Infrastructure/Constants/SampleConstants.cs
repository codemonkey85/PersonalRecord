namespace PersonalRecord.Infrastructure.Constants
{
    public static class SampleConstants
    {
        ...
        public static Guid SampleCleanSecondPrId = Guid.Parse("b1bffe52-f3dd-42db-ad37-e3f38649ccda");
        ...
        public const int SAMPLE_CLEAN_SECOND_WEIGHT = 85;
        public const int SAMPLE_DEADLIFT_WEIGHT = 130;

        public static DateTime SamplePrsDate = new(2025, 01, 01);
        public static DateTime SamplePrsSecondDate = new(2025, 02, 01);
